...
“虚拟网卡”: 开启 ``严格路由`` | “DNS劫持” 填写 ``any:53,tcp://any:53``

“订阅与代理组设置”: 关闭 ``接管DNS设置`` 与 ``接管域名嗅探设置``

“内核设置”的“高级设置”: 开启 ``存储选择节点``、``存储FakeIP``、``TCP并发``

## Sub-Store 设置
1.在“订阅管理”界面添加机场的订阅链接，添加名称（例Sub1）。
...
在下方分别添加：
  ...
  链接②:``https://raw.githubusercontent.com/Kwensiu/ProxyRule/refs/heads/main/Latest.yaml``
